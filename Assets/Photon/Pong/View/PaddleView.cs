namespace Quantum.Pong
{
  ...
  using Text = UnityEngine.UI.Text;
    ...
    public unsafe class PaddleView : QuantumEntityViewComponent
  {
    /// <summary>
    ...
    /// <para>Initializes the player name and rotation.</para>
    /// <para>Applies different transforms to the initial ship based on QUANTUM_YX.</para>
    /// </summary>
    ...
    public override void OnUpdateView()
    {
      ...
      PongGameConfig config = PredictedFrame.FindAsset<PongGameConfig>(PredictedFrame.RuntimeConfig.GameConfig);
      Paddle shipFields = PredictedFrame.Get<Paddle>(EntityRef);
